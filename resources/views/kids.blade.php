            ...
            <div id="article" class="container">
                <div class="row">
                    ...
                    <div id="menu" class="col-md-2 col-3">
                        <ul class="aside">
                            <li><a href="{{asset('/Kids/Cloth')}}">上衣類</a>
                                <ul class="aside-sub">
                                    <li><a href="#">短T</a></li>
                                    <li><a href="#">長T</a></li>
                                    <li><a href="#">襯衫</a></li>
                            ...
                            <li><a href="{{asset('/Kids/Pant')}}">褲子類</a>
                                <ul class="aside-sub">
                                    <li><a href="#">短褲</a></li>
                                    <li><a href="#">長褲</a></li>
                                    <li><a href="#">牛仔褲</a></li>
                            ...
                            <li><a href="{{asset('/Kids/Coat')}}">外套類</a>
                                <ul class="aside-sub">
                                    <li><a href="#">羽絨</a></li>
                                    <li><a href="#">休閒</a></li>
                                    <li><a href="#">防水</a></li>
                            ...
                            <li><a href="{{asset('/Kids/Underwear')}}">家居類</a>
                                <ul class="aside-sub">
                                    <li><a href="#">睡衣</a></li>
                                    <li><a href="#">內衣/內褲</a></li>
                                </ul>
                            </li>
                            <li><a href="{{asset('/Kids/Other')}}">配件類</a>
                                <ul class="aside-sub">
                                    <li><a href="#">皮帶</a></li>
                                    <li><a href="#">襪子</a></li>
                                    <li><a href="#">鞋子</a></li>
                                    ...
                                    <div class="card p-1 text-center">
                                        <a href="/Detail/{{ $kid->lotid }}"  target="_blank">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if(is_null($kid->saleprice))
                                                    <p class="nosale-price card-text">NT${{$kid->price}}</p>
                                                @else
                                                    <p class="card-text">
                                                        <span class="ori-price">原價{{$kid->price}}</span>
                                                        <span class="sale-price text-danger">活動價NT${{$kid->saleprice}}</span>
                                                    </p>
                                                @endif
                                            </div>
                                        </a>
