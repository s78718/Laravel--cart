        ...
        <div id="article" class="container">
            <div class="row">
                <div id="menu" class="col-md-2 col-3">
                    <ul class="aside">
                        <li><a href="{{asset('/Search/Woman')}}">上衣類</a>
                            <ul class="aside-sub">
                                <li><a href="#">短T</a></li>
                                <li><a href="#">長T</a></li>
                                <li><a href="#">襯衫</a></li>
                ...
                <div id="main" class="col-md-10 col-9">
                    <div class="row">
                        ...
                        @if(isset($womanclothes))
                            @foreach ($womanclothes as $womancloth)
                            <div class="col-md-4 col-12">
                                <a href="#">
                                    <div class="card mr-1 mb-3 p-2 text-center">
                                        <img src="https://picsum.photos/200/200?random=8" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <p class="card-text">{{$womancloth->product}}</p>
                                            <p class="card-text">NT${{$womancloth->price}}</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
